...
public abstract class MapObject {
    ...
    // tile stuff
    protected final PlatformMap platformMap;
    ...
    // constructor
    public MapObject(PlatformMap tm) {
        platformMap = tm;
        tileSize = tm.getPlatformSize();
    }
    ...
    public void calculateCorners(double x, double y) {
        ...
        int tl = platformMap.getType(topTile, leftTile);
        int tr = platformMap.getType(topTile, rightTile);
    ...
    public void setMapPosition() {
        xmap = platformMap.getx();
        ymap = platformMap.gety();
    }
